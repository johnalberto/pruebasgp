...
public class ILocalidadServicio_Proxy extends RemoteServiceProxy implements com.cpcoriente.cidecuero.springgwt.MrpCrm.client.ILocalidadServicioAsync {
  private static final String REMOTE_SERVICE_INTERFACE_NAME = "com.cpcoriente.cidecuero.springgwt.MrpCrm.client.ILocalidadServicio";
  private static final String SERIALIZATION_POLICY ="1E55E6C23C8D6227EADE121BFF0586B0";
  private static final com.cpcoriente.cidecuero.springgwt.MrpCrm.client.ILocalidadServicio_TypeSerializer SERIALIZER = new com.cpcoriente.cidecuero.springgwt.MrpCrm.client.ILocalidadServicio_TypeSerializer();
  ...
  public void buscarCiudadPorNombre(java.lang.String parteNombre, com.google.gwt.user.client.rpc.AsyncCallback callback) {
  ...
  public void buscarDptoPorNombre(java.lang.String parteNombre, com.google.gwt.user.client.rpc.AsyncCallback callback) {
    RpcStatsContext statsContext = new RpcStatsContext();
  ...
  public void crearCiudad(com.cpcoriente.cidecuero.springgwt.MrpCrm.shared.localidad.objeto.CiudadTO ciudad, com.google.gwt.user.client.rpc.AsyncCallback callback) {
    RpcStatsContext statsContext = new RpcStatsContext();
    ...
    try {
      ...
      streamWriter.writeInt(1);
      streamWriter.writeString("com.cpcoriente.cidecuero.springgwt.MrpCrm.shared.localidad.objeto.CiudadTO/1622491800");
  ...
  public void crearDpto(com.cpcoriente.cidecuero.springgwt.MrpCrm.shared.localidad.objeto.DepartamentoTO dpto, com.google.gwt.user.client.rpc.AsyncCallback callback) {
    RpcStatsContext statsContext = new RpcStatsContext();
    ...
    try {
      ...
      streamWriter.writeInt(1);
      streamWriter.writeString("com.cpcoriente.cidecuero.springgwt.MrpCrm.shared.localidad.objeto.DepartamentoTO/1910476979");
  ...
  public void crearPais(com.cpcoriente.cidecuero.springgwt.MrpCrm.shared.localidad.objeto.PaisTO pais, com.google.gwt.user.client.rpc.AsyncCallback callback) {
    RpcStatsContext statsContext = new RpcStatsContext();
    ...
    try {
      ...
      streamWriter.writeInt(1);
      streamWriter.writeString("com.cpcoriente.cidecuero.springgwt.MrpCrm.shared.localidad.objeto.PaisTO/411343346");
  ...
  public void modificarCiudad(com.cpcoriente.cidecuero.springgwt.MrpCrm.shared.localidad.objeto.CiudadTO ciudad, com.google.gwt.user.client.rpc.AsyncCallback callback) {
    RpcStatsContext statsContext = new RpcStatsContext();
  ...
  public void modificarDpto(com.cpcoriente.cidecuero.springgwt.MrpCrm.shared.localidad.objeto.DepartamentoTO dpto, com.google.gwt.user.client.rpc.AsyncCallback callback) {
    RpcStatsContext statsContext = new RpcStatsContext();
  ...
  public void modificarPais(com.cpcoriente.cidecuero.springgwt.MrpCrm.shared.localidad.objeto.PaisTO pais, com.google.gwt.user.client.rpc.AsyncCallback callback) {
    RpcStatsContext statsContext = new RpcStatsContext();
