...
public class ILocalidadServicio_TypeSerializer extends com.google.gwt.user.client.rpc.impl.SerializerBase {
  ...
  private static Map<String, TypeHandler> loadMethodsJava() {
    ...
    result.put("[Lcom.cpcoriente.cidecuero.springgwt.MrpCrrmM.shared.localidad.objeto.PaisTO;/3927543428", new com.cpcoriente.cidecuero.springgwt.MrpCrrmM.shared.localidad.objeto.PaisTO_Array_Rank_1_FieldSerializer.Handler());
  ...
  private static native MethodMap loadMethodsNative() /*-{
    ...
    result["[Lcom.cpcoriente.cidecuero.springgwt.MrpCrrmM.shared.localidad.objeto.PaisTO;/3927543428"] = [
        @com.cpcoriente.cidecuero.springgwt.MrpCrrmM.shared.localidad.objeto.PaisTO_Array_Rank_1_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @com.cpcoriente.cidecuero.springgwt.MrpCrrmM.shared.localidad.objeto.PaisTO_Array_Rank_1_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;[Lcom/cpcoriente/cidecuero/springgwt/MrpCrrmM/shared/localidad/objeto/PaisTO;),
      ];
  ...
  private static Map<Class<?>, String> loadSignaturesJava() {
    ...
    result.put(com.cpcoriente.cidecuero.springgwt.MrpCrrmM.shared.localidad.objeto.PaisTO_Array_Rank_1_FieldSerializer.concreteType(), "[Lcom.cpcoriente.cidecuero.springgwt.MrpCrrmM.shared.localidad.objeto.PaisTO;/3927543428");
  ...
  private static native JsArrayString loadSignaturesNative() /*-{
    ...
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@com.cpcoriente.cidecuero.springgwt.MrpCrrmM.shared.localidad.objeto.PaisTO[]::class)] = "[Lcom.cpcoriente.cidecuero.springgwt.MrpCrrmM.shared.localidad.objeto.PaisTO;/3927543428";
