...
public class IMaquinaServicio_TypeSerializer extends com.google.gwt.user.client.rpc.impl.SerializerBase {
  ...
  private static Map<String, String> loadMethodsJava() {
    ...
    result.put("com.cpcoriente.cidecuero.springgwt.MrpCrrmM.shared.maquina.objeto.CaracteristicaTO/4049295150", "com.cpcoriente.cidecuero.springgwt.MrpCrrmM.shared.maquina.objeto.CaracteristicaTO_FieldSerializer");
    result.put("[Lcom.cpcoriente.cidecuero.springgwt.MrpCrrmM.shared.maquina.objeto.CaracteristicaTO;/1198898598", "com.cpcoriente.cidecuero.springgwt.MrpCrrmM.shared.maquina.objeto.CaracteristicaTO_Array_Rank_1_FieldSerializer");
    result.put("com.cpcoriente.cidecuero.springgwt.MrpCrrmM.shared.maquina.objeto.MaquinaTO/86806194", "com.cpcoriente.cidecuero.springgwt.MrpCrrmM.shared.maquina.objeto.MaquinaTO_FieldSerializer");
    result.put("[Lcom.cpcoriente.cidecuero.springgwt.MrpCrrmM.shared.maquina.objeto.MaquinaTO;/2744230282", "com.cpcoriente.cidecuero.springgwt.MrpCrrmM.shared.maquina.objeto.MaquinaTO_Array_Rank_1_FieldSerializer");
  ...
  private static Map<String, String> loadSignaturesJava() {
    ...
    result.put("com.cpcoriente.cidecuero.springgwt.MrpCrrmM.shared.maquina.objeto.CaracteristicaTO", "com.cpcoriente.cidecuero.springgwt.MrpCrrmM.shared.maquina.objeto.CaracteristicaTO/4049295150");
    result.put("[Lcom.cpcoriente.cidecuero.springgwt.MrpCrrmM.shared.maquina.objeto.CaracteristicaTO;", "[Lcom.cpcoriente.cidecuero.springgwt.MrpCrrmM.shared.maquina.objeto.CaracteristicaTO;/1198898598");
    result.put("com.cpcoriente.cidecuero.springgwt.MrpCrrmM.shared.maquina.objeto.MaquinaTO", "com.cpcoriente.cidecuero.springgwt.MrpCrrmM.shared.maquina.objeto.MaquinaTO/86806194");
    result.put("[Lcom.cpcoriente.cidecuero.springgwt.MrpCrrmM.shared.maquina.objeto.MaquinaTO;", "[Lcom.cpcoriente.cidecuero.springgwt.MrpCrrmM.shared.maquina.objeto.MaquinaTO;/2744230282");
  ...
  public IMaquinaServicio_TypeSerializer() {
