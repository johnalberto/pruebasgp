...
@NamedQueries({
	@NamedQuery(name = "actEco.listarTodo", query = "select act from ActividadEnonomicaDO act"),
...
public class ActividadEnonomicaDO implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ActividadEnonomicaDO other = (ActividadEnonomicaDO) obj;
		if (codigo == null) {
